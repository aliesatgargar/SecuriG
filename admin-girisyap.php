            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="kayitol.php" class="signup-image-link">Hesabınız yok mu? Kayıt Olun!!</a>
                    </div>
                </div>
            </div>
        </section>
...
{
$_SESSION['kullaniciadi'] = $username; // Session'a aktardık kullaniciadi değerini
header('location: uyeler.php'); // ndex.php'ye yönlendiriyoruz
